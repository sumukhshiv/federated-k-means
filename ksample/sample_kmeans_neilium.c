...
int main(int argc, char const *argv[]) {
  ...
  double cluster_initial[2][dim];
  cluster_initial[0][0] = 7.0;
  cluster_initial[0][1] = 10.0;
  cluster_initial[0][2] = 17.0;
  cluster_initial[1][0] = 9.0;
  cluster_initial[1][1] = 21.0;
  cluster_initial[1][2] = 19.0;

  int cluster_final[2][dim];
